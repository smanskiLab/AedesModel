...
timeStepAdded = 40                                 # number of time steps between intermittent addition; NOTE, a .pkl file is saved at each of these steps. If no additions are wanted, set this number to the last timestep recorded.
timeSteps = 322                                     # Duration of simulation in steps
migrationRate = 0                                   # Do not change this if using the three populations as replicate single-populations
...
borderCells = 0                                     #with of 'Wild-type only' border
